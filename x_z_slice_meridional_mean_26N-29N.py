...
#cdo selindexbox,1950,2600,530,585 ../div_U+rho+.nc div_U+rho+_stripe.nc
#cdo selindexbox,1950,2600,530,585 ../v+rho+.nc v+rho+_stripe.nc
#cdo selindexbox,1950,2600,530,585 ../u+rho+.nc u+rho+_stripe.nc
# cdo selindexbox,1950,2600,530,585 ../w+rho+.nc w+rho+_stripe.nc
#cdo selindexbox,1950,2600,530,585 ../U_grad_rho.nc U_grad_rho_stripe.nc
#cdo selindexbox,1950,2600,530,585 /work/mh0256/m300522/data_storm/tape/60-90/vke_60-90_tm.nc vke_stripe.nc
#cdo selindexbox,1950,2600,530,585 /work/mh0256/m300522/data_storm/tape/60-90/uko_60-90_tm.nc uko_stripe.nc
#cdo selindexbox,1950,2600,530,585 /work/mh0256/m300522/data_storm/tape/60-90/wo_p_60-90_tm.nc wo_p_stripe.nc
#cdo selindexbox,1950,2600,530,585 /work/mh0256/m300522/data_storm/tape/60-90/rhopoto_60-90_tm.nc rhopoto_stripe.nc
# cdo selindexbox,1950,2600,530,585 ../dz_rhopoto.nc dz_rhopoto_stripe.nc
# cdo selindexbox,1950,2600,530,585 ../dx_rhopoto.nc dx_rhopoto_stripe.nc
# cdo selindexbox,1950,2600,530,585 ../dy_rhopoto.nc dy_rhopoto_stripe.nc
# cdo selindexbox,1950,2600,530,585 ../Pe2Pm_hor.nc Pe2Pm_hor_stripe.nc
...
high=5e-9
b = aplot.myplot_multi2(x,z,data_rho,x,z,data_vke,x,z,data_divUrho,high,'Eddy Density Fluxes between 26N and 29N')
b.canvas.set_window_title('Eddy Fluxes of Density between 26N and 29N')
b.savefig("26N-29N_eddy_flux_divergence.png")

a = aplot.myplot_multi2(x,z,data_rho,x,z,data_vke,x,z,data_U_grad_rho,high,'Mean advection of density between 26N and 29N'	)
a.canvas.set_window_title('Mean advection of density between 26N and 29N')
a.savefig("26N-29N_density_advection.png")

c = aplot.myplot_quiver(x3,z3,data_rho,x,z,110*u_dia,w_dia,'Diapycnal Eddy fluxes')
c.savefig("26N-29N_diapycnal_fluxes.png")

high = 1e-11
d = aplot.myplot_multi2(x,z,data_rho,x,z,data_vke,x,z,data_Pe2Pm_hor,high,'Conversion eddy to mean potential energy 26N-29N')
d.canvas.set_window_title('Conversion eddy to mean potential energy 26N-29N')
d.savefig("26N-29N_Conv_eddy2mean.png")
